...
function ErrorContent() {
  ...
  useEffect(() => {
    setErrorMessage(searchParameters.get('message') || 'An unexpected error occurred');
  }, [searchParameters]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
      ...
      <div className="max-w-md w-full mx-auto px-4">
        <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-2xl p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">Installation Failed</h2>

          <p className="text-gray-400 mb-6">{errorMessage}</p>

          <div className="bg-gray-800/50 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-400">
              If this problem persists, please contact support or check the integration
              documentation.
            </p>
          </div>
